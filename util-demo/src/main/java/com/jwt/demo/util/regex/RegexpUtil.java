...
public class RegexpUtil {
     ...
     * ipv4 cidr校验
     */
    private static final String IPV4_CIDR_REGEX = "^((2[0-4]\\d|25[0-5]|[01]?\\d\\d?)\\.){3}(2[0-4]\\d|25[0-5]|[01]?\\d\\d?)[/](\\d|[1-2]\\d|3[0-2])";
     ...
     * 员工编号
     */
    private static final Pattern STAFF_NO_PATTERN = Pattern.compile("^[A-DF-SUW-Z0-9][A-Z0-9]{0,15}$");
     ...
     * 手机号校验正则
     */
    private static final String PHONE_REGEX = "^1[3456789][0-9]{9}$";
     ...
     * 车牌号校验规则
     */
    private static final String CAR_NUM_PATTERN = "^([京津晋冀蒙辽吉黑沪苏浙皖闽赣鲁豫鄂湘粤桂琼渝川贵云藏陕甘青宁新][ABCDEFGHJKLMNPQRSTUVWXY][1-9DF][1-9ABCDEFGHJKLMNPQRSTUVWXYZ]\\d{3}[1-9DF]|[京津晋冀蒙辽吉黑沪苏浙皖闽赣鲁豫鄂湘粤桂琼渝川贵云藏陕甘青宁新][ABCDEFGHJKLMNPQRSTUVWXY][\\dABCDEFGHJKLNMxPQRSTUVWXYZ]{5})$";
    ...
    public static void main(String[] args) {
        String verifyCodeRegex = "[0-9.]+";
        String str = "12345.";
        System.out.println(str.matches(verifyCodeRegex));
        keep2Decimal(0.0);
    }
